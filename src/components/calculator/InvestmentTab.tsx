  ...
  return (
    <div className="bg-[#2a2a2a] p-[24px] rounded-[16px] border border-[#333] flex flex-col h-full hover:border-[#444] transition-colors duration-300 w-full">
      <div className="mb-[20px]">
        ...
        <p className="text-[#888] text-[13px] m-0 leading-relaxed">추가 매수 시 최종 평단가와 수량이 어떻게 변하는지 미리 시뮬레이션 합니다.</p>
      </div>

      <div className="grid grid-cols-2 gap-[15px] mb-[20px]">
        <div>
          <label className="block text-[12px] text-[#bdc3c7] mb-[5px]">현재 평단가 (원)</label>
        ...
        <div>
          <label className="block text-[12px] text-[#bdc3c7] mb-[5px]">현재 보유 수량 (주)</label>
        ...
        <div>
          <label className="block text-[12px] text-[#bdc3c7] mb-[5px]">추가 매수 단가 (원)</label>
        ...
        <div>
          <label className="block text-[12px] text-[#bdc3c7] mb-[5px]">추가 매수 수량 (주)</label>
      ...
      <div className="mt-auto pt-[20px] border-t border-[#3a3a3a] flex flex-col gap-[8px]">
        <div className="flex justify-between items-end text-[#333]">
          <span className="font-bold text-[#bdc3c7] text-[13px]">최종 평단가</span>
        ...
        <div className="flex justify-between items-end text-[#333]">
          <span className="font-bold text-[#bdc3c7] text-[13px]">최종 수량 / 총 금액</span>
          <span className="text-[#bdc3c7] font-bold text-[16px]">{formatComma(totalQty)} 주 / {formatComma(totalAmt)} 원</span>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-[#2a2a2a] p-[24px] rounded-[16px] border border-[#333] flex flex-col h-full hover:border-[#444] transition-colors duration-300 w-full">
      <div className="mb-[20px]">
        ...
        <p className="text-[#888] text-[13px] m-0 leading-relaxed">뇌동매매를 방지하기 위해 기계적인 목표 매도가와 손절가를 계산합니다.</p>
      </div>

      <div className="mb-[15px]">
        <label className="block text-[12px] text-[#bdc3c7] mb-[5px]">매수 단가 (원)</label>
      ...
      <div className="grid grid-cols-2 gap-[15px] mb-[20px]">
        <div>
          <label className="block text-[12px] text-[#bdc3c7] mb-[5px]">목표 수익률 (%)</label>
        ...
        <div>
          <label className="block text-[12px] text-[#bdc3c7] mb-[5px]">손절 기준률 (%)</label>
      ...
      <div className="mt-auto pt-[20px] border-t border-[#3a3a3a] flex flex-col gap-[12px]">
        <div className="flex justify-between items-end text-[#333]">
          <span className="font-bold text-[#bdc3c7] text-[13px]">익절 목표가 <span className="text-[#ff4d4f]">+{pRate}%</span></span>
          <span className="text-[#ff4d4f] font-bold text-[24px]">{formatComma(targetPrice.toFixed(0))} <span className="text-[16px]">원</span></span>
        </div>
        <div className="flex justify-between items-end text-[#333]">
          <span className="font-bold text-[#bdc3c7] text-[13px]">기계적 손절가 <span className="text-[#4096ff]">-{lRate}%</span></span>
